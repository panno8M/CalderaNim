...
when isMainModule:
  ...
  bench(setup, m):
    for i in 1..m:
      ...
      # destroy pipelineLayout
      # destroy renderPass
      # for imageview in swapchainInfo.imageViews.mItems:
      #   destroy imageview
      # for framebuffer in swapchainInfo.framebuffers.mItems:
      #   destroy framebuffer
      # destroy swapchain
      # destroy descriptorSetLayout
      ...
      # destroy indexSource
      # destroy vertexSource
      # destroy semaphore.imageAvailable
      # destroy semaphore.renderingFinished
      # destroy surface
      # destroy device
      # destroy instance
  runBenchmarks()